...
new_model = tf.keras.models.load_model('modelpeupliers.h5')
...
rM.add_function(predict_dl, out_image='peupliers_predict.tif',model=new_model,insize=SIZE,rescalesize=rescale_size)
rM.run('100M')
